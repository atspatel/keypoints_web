...
export const video_url = `${BASE_DIR}/media/realme_demo_1_compressed.mp4`;

export const url_thumbnail = `${BASE_DIR}/media/realme_thumbnail.png`;

export const realme_logo = `${BASE_DIR}/media/realme_logo_transparent.png`;
export const gadgets360_logo = `${BASE_DIR}/media/gadgets360_logo.png`;
