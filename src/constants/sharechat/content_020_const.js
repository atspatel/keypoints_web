...
const BASE_DIR_video = `${sharechat_constants.BASE_DIR_sharechat}/content_0905_005`;

export const video_id = "content_0905_005";
export const isSingleAudio = false;
export const audioFile = { tamil: null };

export const title = {
  tamil: "உங்களுக்கு பிடித்த ஸ்டேட்டஸை தேர்வுசெய்க"
};
