...
export const title = {
  ...
  tamil: "விநாயகர் பார்க்கும் இடமெல்லாம் மகிழ்ச்சி பொங்கும்",
  telugu: ".బుజ్జి గణపయ్య రాకతో ప్రతిచోటా వాతావరణం చాలా సరదాగా మారిపోతుంది.",
  kannada: "ಗಣಪತಿಯ ಆಗಮನದೊಂದಿಗೆ ಎಲ್ಲೆಡೆ ಮೋಜಿನ ವಾತಾವರಣ."
};
